    ...
    <section class="contact">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Survey</h2>
          <p class="font-weight-bold"><?= $survey->nama_survei ?></p>
                ...
                <div class="info">
                    <form action="">
                        <table class="table table-borderless">
                            <tr>
                                <td colspan="2">Isi survey !</td>
                            </tr>
                            <?php
                                $no=1; 
                                foreach($surveyPertanyaan as $pertanyaan):
                            ?>
                                <tr>
                            ...
                            <?php 
                                    foreach($surveyJawaban as $jawaban):
                                        if($jawaban->id_pertanyaan==$pertanyaan->id){
                            ?>
                        ...
                        <input type="submit" class="btn btn-primary btn-sm float-right" name="submit" value="Selesai">
                    </form>
                </div>
            </div>
        </div>
