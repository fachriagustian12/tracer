...
<body>
    ...
    <header id="header">
        <div class="d-flex flex-column">
            ...
            <nav class="nav-menu">
                <ul>
                    <li class="active"><a href="<?= base_url('alumni') ?>" id="home"><i class="bx bx-home"></i>
                            <span>Home</span></a></li>
            ...
            <div class="container">
                ...
                <div class="row" data-aos="fade-in">
                    <div class="col-lg-12 d-flex align-items-stretch">
                        <div class="info">
                            <form action="<?= base_url('updateProfil/'.$user->id.'/'.$user->id_user_grup) ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="tahun_lulus" id="datepicker1"
                                        value="<?= $user->tahun_lulus?>" placeholder="Tahun lulus" required />
                                </div>
                                <div class="form-group">
                                    <label for="Angkatan" class="form-control-label">Angkatan</label>
                                    <input type="text" class="form-control" name="angkatan" id="datepicker2"
                                        value="<?= $user->angkatan?>" placeholder="Angkatan" required />
                                </div>
                                <div class="form-group">
                                    <label for="Angkatan" class="form-control-label">Mulai Kerja</label>
                                    <input type="text" class="form-control" name="mulai_kerja" id="datepicker3"
                                        value="<?= $user->mulai_kerja?>" placeholder="Mukai Kerja Tahun" required />
                                </div>
                                <div class="form-group">
                                ...
                                ?>
                                    ...
                                    <input type="text" class="form-control" name="old_bidang_pekerjaan"
                                        value="<?= $user->bidang_pekerjaan ?>" hidden>
                                </div>
                                <div class="form-group">
                                    <label for="Alamat" class="form-control-label">Alamat Kerja</label>
                                    <input type="text area" name="alamat_kerja" class="form-control"
                                        value="<?= $user->alamat_kerja?>" id="alamat" placeholder="Alamat Kantor"
                                        required />
                                </div>
                                <div class="form-group">
                                    <label for="Kota" class="form-control-label" Kota>Kota</label>
                                    <input type="text" name="kota" id="alamat" class="form-control"
                                        value="<?= $user->kota?>" placeholder="Kota" required />
                                </div>
                                <div class="form-group">
                                    <label for="nama_depan" class="form-control-label">Foto</label>
                                    <input type="file" class="form-control" name="new_foto">
                                    <input type="text" class="form-control" name="old_foto" value="<?= $user->foto?>"
                                        hidden>
                                </div>
                                <div class="form-group">
                                    <input type="submit" class="btn btn-primary btn-sm float-right" name="submit"
                                        value="Simpan">
                                </div>
                            </form>
                        </div>
