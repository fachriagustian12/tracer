  ...
  ?>
    ...
    <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
        ...
        <div class="hero-container" data-aos="fade-in">
            <h1><?= ucfirst($this->session->userdata('nama_depan'))." ".ucfirst($this->session->userdata('nama_belakang'))?>
            </h1>
        ...
        <section id="about" class="about">
            <div class="container">
                ...
                <div class="section-title">
                    <h2>About <span class="float-right"><a
                                href="<?= base_url('editProfil/'.$this->session->userdata('id')) ?>" id="profilEdit"
                                class="btn btn-primary btn-sm"><i class="bx bx-edit"></i> Edit Profil </a></span> </h2>
                    <!-- <p>Magnam dolores commodi suscipit. Necessitatibus eius consequatur ex aliquid fuga eum quidem. Sit sint consectetur velit. Quisquam quos quisquam cupiditate. Et nemo qui impedit suscipit alias ea. Quia fugiat sit in iste officiis commodi quidem hic quas.</p> -->
                </div>

                <div class="row">
                    <div class="col-lg-4" data-aos="fade-right">
                        <img src="<?= base_url('assets')?>/user/<?= $this->session->userdata('foto')?>"
                            class="img-fluid" alt="">
                    </div>
              ...
              magna aliqua.
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <ul>
                                    <li><i class="icofont-rounded-right"></i> <strong>Tanggah Lahir: </strong>
                                        <?= $user->tgl_lahir?></li>
                                    <li><i class="icofont-rounded-right"></i> <strong>Jenis Kelamin: </strong>
                                        <?= $user->jenis_kelamin?>
                                    <li><i class="icofont-rounded-right"></i> <strong>Telepon : </strong>
                                        <?= $user->telp?></li>
                                    <li><i class="icofont-rounded-right"></i> <strong>Alamat: </strong>
                                        <?= $user->alamat?></li>
                                    <li><i class="icofont-rounded-right"></i> <strong>Bidang Pekerjaan:
                                        </strong><?php foreach($bidang_pekerjaan as $bp): if($bp->id==$user->bidang_pekerjaan){ echo $bp->nama;} endforeach; ?>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-lg-6">
                                <ul>
                                    <li><i class="icofont-rounded-right"></i> <strong>Email:</strong> <?= $user->email?>
                                    </li>
                                    <li><i class="icofont-rounded-right"></i> <strong>Tahun Lulus:</strong>
                                        <?= $user->tahun_lulus?></li>
                                    <li><i class="icofont-rounded-right"></i> <strong>Angkatan:</strong>
                                        <?= $user->angkatan?></li>
                                    <li><i class="icofont-rounded-right"></i> <strong>Mulai Kerja:</strong>
                                        <?= $user->mulai_kerja?></li>
                                    <li><i class="icofont-rounded-right"></i> <strong>Konsentrasi Skripsi:</strong>
                                        <?php foreach($konsentrasi as $k): if($k->id==$user->konsentrasi){ echo $k->konsentrasi;} endforeach; ?>
                                    </li>
                                </ul>
                            </div>
                        </div>
        ...
        <section id="portfolio" class="portfolio section-bg">
            <div class="container">
                ...
                <div class="section-title">
                    ...
                    <p>Silahkan tambahkan atau lihat lowongan pekerjaan yang tersedia yang telah di tambahkan alumni
                        lainnya</p>
                </div>
                ...
                <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="col-lg-3 col-md-4 portfolio-item filter-app">
                        <div class="portfolio-wrap">
                            <img src="<?= base_url('assets/loker/'.$loker->foto)?>" width="100%" class="img-fluid"
                                alt="">
                            <div class="portfolio-links">
                                <a href="<?= base_url('assets/loker/'.$loker->foto)?>" data-gall="portfolioGallery"
                                    class="venobox" title="Klik untuk memperbesar Gambar"><i
                                        class="bx bx-images"></i></a>
                                <a href="<?= base_url('detailLoker/'.$loker->id) ?>" title="Detail Loker"><i
            ...
            <div class="container">
                ...
                <div class="row" data-aos="fade-in">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="<?= base_url('frontend/loker/tambah/'.$this->session->userdata('id')) ?>"
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" name="tgl_buat" class="form-control" id="datepicker"
                                                required />
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="name">Batas Akhir lowongan</label>
                                            <input type="text" class="form-control" name="tgl_akhir" id="datepicker1"
                                                required />
                                        </div>
                                    </div>
                                    <div class="form-group">
        ...
        <section id="services" class="services">
          ...
          ?>
                    <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up">
                        ...
                        <a href="<?= base_url('detailSurvey/'.$survey->id) ?>"
                            class="btn btn-primary btn-sm float-right">Mulai Survey <i
                                class="bx bx-right-arrow p-t-3"></i></a>
                    </div>
                    <?php endforeach; } ?>
                </div>
            ...
            <div class="container">
                ...
                <div class="row" data-aos="fade-in">
                    <div class="col-lg-12 mt-5 mt-lg-0 d-flex align-items-stretch">
                        <form action="<?= base_url('backend/users/ubahpassword') ?>" method="post" role="form"
                            ...
                            <div class="text-center">
                                <a class="btn btn-secondary btn-sm float-left text-white" id="showpassword"><i
                                        class="bx bx-show-alt"></i> lihat password</a>
                                <input class="btn btn-info btn-sm float-right" name="submit" type="submit"
                                    value="simpan">
                            </div>
                        </form>
                    </div>
