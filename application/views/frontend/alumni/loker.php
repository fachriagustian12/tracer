    ...
    <main id="main">
        <section id="contact" class="contact">
            <div class="container">
                    ...
                    <div class="col-lg-6  align-items-stretch">
                        <div class="info">
                            <a href="<?= base_url('assets/loker/'.$loker->foto)?>" data-gall="portfolioGallery"
                                class="venobox" title="Klik untuk memperbesar Gambar"><img
                                    src="<?= base_url('assets/loker/'.$loker->foto) ?>"
                ...
                ?>
                            <p class="font-weight-light">Sumber Informasi :
                                <?= ucfirst($user->nama_depan).' '.ucfirst($user->nama_belakang) ?></p>
                            <?php
                        }
                    endforeach
                ?>
