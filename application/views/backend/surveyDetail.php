<div class="content-wrapper">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-7">
                    ...
                    <div class="card-body">
                        <h5 class="card-title font-weight-bold"><?= $survey->nama_survei ?></h5>
                        <p class="card-text">
                        <?= $survey->deskripsi ?>
                        </p>
                    </div>
                ...
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        ...
                        <div class="card-body">
                            <form action="<?= base_url('backend/survey_pertanyaan/tambah/'.$title) ?>" method="post">
                                <div class="form-group">
                                    <label for="" class="form-control-label">Pertanyaan</label>
  ...
  <?php
  foreach ($surveyPertanyaan2 as $survey) {
    ?>
